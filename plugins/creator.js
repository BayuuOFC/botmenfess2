...
${htjava} * Hobby* : Watch Anime.
${htjava} * Sifat* : YTTA
${htjava} * Tinggal* : Indonesia, Tangerang Selatan, Banten
${htjava} * Waifu* : Nakano Yotsuba.
...
handler.help = ['bayuown', 'ownbay']
handler.tags = ['main', 'info']
handler.command = /^(bayuown|ownbay)/i
